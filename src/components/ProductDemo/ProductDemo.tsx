...
const queries = [
  ...
  {
    tag: 'Taking it over - Water utility',
  ...
  {
    tag: 'Digging under it - Water utility',
  ...
  {
    tag: 'Reconstructing history - Water utility',
  ...
  {
    tag: 'Buying it - Manufacturing facility',
    query: 'Are there any underground storage tanks on the north side of the property?',
    matchCount: 2,
    answer: 'One 10,000-gal diesel UST documented in a 1997 tank registration (Permit #UST-4481), north parking area. A 2006 closure report confirms removal with clean confirmation sampling. One active 5,000-gal fire suppression UST remains, last inspected 2023.',
    sources: ['UST Registration Permit #UST-4481 (1997)', 'Tank Closure Report & Confirmation Sampling (2006)'],
  },
  {
    tag: 'Insuring it - Manufacturing facility',
  ...
  {
    tag: 'Taking it over - Manufacturing facility',
    query: 'When was the electrical panel in the east wing last upgraded?',
    matchCount: 3,
    answer: 'Main distribution panel (MDP-E2) upgraded 2017 from 1,200A to 2,000A, 480V/3-phase. Arc flash study completed same year with incident energy 8.4 cal/cm² at MDP-E2. Previous upgrade was 1993.',
  ...
  {
    tag: 'Reconstructing history - Manufacturing facility',
  ...
  {
    tag: 'Building on it - Civil engineering',
  ...
  {
    tag: 'Buying it - Civil engineering',
  ...
  {
    tag: 'Taking it over - Oil & gas pipeline',
  ...
  {
    tag: 'Operating it - Oil & gas pipeline',
  ...
  {
    tag: 'Buying it - Oil & gas pipeline',
  ...
  {
    tag: 'Reconstructing history - Municipal infrastructure',
  ...
  {
    tag: 'Taking it over - Rail & transit',
        ...
        <AnimateIn>
          <div className={styles.header}>
            ...
            <h2 className={styles.title}>
              Every document, structured. Every page, addressable. Every answer, sourced.
            </h2>
            <p className={styles.subtitle}>
              We don't just retrieve documents. We extract what matters: assets, materials, dates, easements, prior work. And we tie every answer back to the exact page in the exact document it came from.
            </p>
          </div>
        </AnimateIn>

        <AnimateIn delay={0.15} duration={1}>
            ...
            <div className={styles.outputCard}>
              ...
              <div className={styles.axisBlock}>
                <div className={styles.axisRow}>
                  <span className={styles.axisKey}>where</span>
                  <span className={styles.axisVal}>lat 39.1083, lng -77.2028, Belward Campus Drive corridor</span>
                </div>
                <div className={styles.axisRow}>
                  <span className={styles.axisKey}>when</span>
                  <span className={styles.axisVal}>drawn 2022-03-14, filed 2022-04-02, current as of last revision 2023-01-09</span>
                </div>
                <div className={styles.axisRow}>
                  <span className={styles.axisKey}>what</span>
                  <span className={styles.axisVal}>see extracted features and notes below</span>
                </div>
              </div>
          ...
          <div className={styles.searchHeaderRow}>
            <div className={styles.searchHeader}>
              ...
              <h3 className={styles.searchTitle}>
                Plain-English questions. Sourced answers, anchored in space and time.
              </h3>
            </div>
